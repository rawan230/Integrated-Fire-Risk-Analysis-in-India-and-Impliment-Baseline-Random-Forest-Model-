"""
Step 7 evaluation statistics -- verbatim port of the verified audit module
results/code/eval_utils.py (audit of record 2026-09-24/25, results/FULL_METHODOLOGY_AUDIT.md).
The fast DeLong implementation was verified against a brute-force computation in the audit.
Do not change the numerics without re-verifying against results/baseline/CLASSICAL_METRICS.csv.
